...
todo=("xglm-2.9B facebook/xglm-2.9B 0 3e-5 1 0.4" "xglm-2.9B facebook/xglm-2.9B 485 3e-5 1 0.4") # <-1,4 끝나면
# todo=("bloom-3b bigscience/bloom-3b 0 1e-5 1 0.4" "bloom-3b bigscience/bloom-3b 485 1e-5 1 0.4")
